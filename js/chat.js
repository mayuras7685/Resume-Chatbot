...
function askDrive() {
  ...
  var line2 =
    createDivs() +
    "<a onclick='writeDrive()'>" +
    json.drive.line2 +
    "</a>" +
    closeDivs()
  var line3 =
    createDivs() +
    "<a onclick='askObjective()'>" +
    json.drive.line3 +
    "</a>" +
    closeDivs()
...
function askWork1Date() {
  var line1 =
    createDivs() +
    json.work1.work1Date.line1 +
    "<b>" +
    sessionStorage.getItem("Work1Name") +
    "</b>." +
    closeDivs()
...
function askWork2Date() {
  var line1 =
    createDivs() +
    json.work2.work2Date.line1 +
    "<b>" +
    sessionStorage.getItem("Work2Name") +
    "</b>." +
    closeDivs()
...
function askWork3Date() {
  var line1 =
    createDivs() +
    json.work3.work3Date.line1 +
    "<b>" +
    sessionStorage.getItem("Work3Name") +
    "</b>." +
    closeDivs()
...
function askEducation1Course() {
  var line1 =
    createDivs() + json.education1.education1Course.line1 + closeDivs()

  document.getElementById("msg").innerHTML = line1
  document.getElementById("send").onclick = function () {
    saveEducation1Course()
  }
}
...
function education2() {
  ...
  var line2 =
    createDivs() +
    "<a onclick='askEducation2Institute()'>" +
    json.education2.line2 +
    "</a>" +
    closeDivs()
  var line3 =
    createDivs() +
    "<a onclick='finish()'>" +
    json.education2.line3 +
    "</a>" +
    closeDivs() //Jump
...
function askEducation2Institute() {
  document.getElementById("userText").disabled = false //unblock textarea
  var line1 =
    createDivs() + json.education2.education2Institute.line1 + closeDivs()

  document.getElementById("msg").innerHTML = line1
  document.getElementById("send").onclick = function () {
    saveEducation2Institute()
  }
}
...
function askEducation2Course() {
  var line1 =
    createDivs() + json.education2.education2Course.line1 + closeDivs()

  document.getElementById("msg").innerHTML = line1
  document.getElementById("send").onclick = function () {
    saveEducation2Course()
  }
}
...
function education3() {
  ...
  var line2 =
    createDivs() +
    "<a onclick='askEducation3Institute()'>" +
    json.education3.line2 +
    "</a>" +
    closeDivs()
  var line3 =
    createDivs() +
    "<a onclick='finish()'>" +
    json.education3.line3 +
    "</a>" +
    closeDivs() //Jump
...
function askEducation3Institute() {
  document.getElementById("userText").disabled = false //unblock textarea
  var line1 =
    createDivs() + json.education3.education3Institute.line1 + closeDivs()

  document.getElementById("msg").innerHTML = line1
  document.getElementById("send").onclick = function () {
    saveEducation3Institute()
  }
}
...
function askEducation3Course() {
  var line1 =
    createDivs() + json.education3.education3Course.line1 + closeDivs()

  document.getElementById("msg").innerHTML = line1
  document.getElementById("send").onclick = function () {
    saveEducation3Course()
  }
}
...
function finish() {
  var line1 =
    createDivs() + "<a onclick='print()'>" + json.finish + "</a>" + closeDivs()
